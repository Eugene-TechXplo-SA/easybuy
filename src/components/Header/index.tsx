                ...
                {user ? (
                  <div className="relative group flex items-center gap-2.5 cursor-pointer">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="font-medium text-custom-sm text-dark truncate max-w-[90px]">
                        {firstName ? `Hi, ${firstName}` : "My Account"}
                      </p>
                    </div>
                    {/* Dropdown */}
                    <div className="absolute top-full right-0 mt-2 w-40 bg-white rounded-lg shadow-lg border border-gray-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                      <Link
                        href="/my-account"
                        className="block px-4 py-2.5 text-custom-sm text-dark hover:bg-gray-1 hover:text-blue rounded-t-lg transition-colors"
                      >
                        My Account
                      </Link>
                      <button
                        onClick={handleSignOut}
                        className="w-full text-left px-4 py-2.5 text-custom-sm text-dark hover:bg-gray-1 hover:text-blue rounded-b-lg transition-colors"
                      >
                        Sign Out
                      </button>
                    </div>
